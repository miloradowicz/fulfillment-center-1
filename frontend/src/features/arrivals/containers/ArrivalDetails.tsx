import { Accordion, AccordionDetails, AccordionSummary, Box, Button, Card, Container, Divider, Grid2 as Grid, IconButton, Stack, Typography } from '@mui/material'
...
const ArrivalDetails = () => {
  const { arrival, loading, confirmDeleteModalOpen, isDeleted, navigateBack, showConfirmDeleteModal, hideConfirmDeleteModal, handleDelete, handleEdit } = useArrivalDetails()
      ...
      <Grid container direction='column'>
        ...
        <Grid>
          <Stack direction='row' justifyContent='flex-end' spacing={2}>
            ...
            <Button variant='outlined' onClick={hideConfirmDeleteModal}>Отмена</Button>
          </Stack>
        </Grid>
      </Grid>
    </Modal>
