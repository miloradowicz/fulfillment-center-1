...
describe('ClientsController', () => {
  ...
  describe('updateClient', () => {
    ...
    it('должен выбросить NotFoundException, если клиент не найден', async () => {
      ...
      await expect(controller.updateClient(clientId, updateClientDto)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('archiveClient', () => {
    ...
    it('должен выбросить ForbiddenException, если клиент уже в архиве', async () => {
      ...
      await expect(controller.archiveClient(clientId)).rejects.toThrow(ForbiddenException)
    })
    ...
    it('должен выбросить NotFoundException, если клиент не найден', async () => {
      ...
      await expect(controller.archiveClient(clientId)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('unarchiveClient', () => {
    ...
    it('должен выбросить ForbiddenException, если клиент не в архиве', async () => {
      ...
      await expect(controller.unarchiveClient(clientId)).rejects.toThrow(ForbiddenException)
    })
    ...
    it('должен выбросить NotFoundException, если клиент не найден', async () => {
      ...
      await expect(controller.unarchiveClient(clientId)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('deleteClient', () => {
    ...
    it('должен выбросить ForbiddenException, если клиент заблокирован', async () => {
      ...
      await expect(controller.deleteClient(clientId)).rejects.toThrow(ForbiddenException)
    })
    ...
    it('должен выбросить NotFoundException, если клиент не найден', async () => {
      ...
      await expect(controller.deleteClient(clientId)).rejects.toThrow(NotFoundException)
    })
  })
})
