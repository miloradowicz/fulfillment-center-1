...
- **passport-local** — стратегия аутентификации по логину и паролю
...
### Документация API
- **Swagger (OpenAPI)** — автогенерация документации через `@nestjs/swagger`
...
- **@nestjs/cli** — CLI NestJS для генерации и запуска проектов
